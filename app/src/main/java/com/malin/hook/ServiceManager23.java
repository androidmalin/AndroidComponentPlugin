...
public final class ServiceManager23 {

    private static final String TAG = "ServiceManager23";

    private static volatile ServiceManager23 sInstance;
    ...
    public synchronized static ServiceManager23 getInstance() {
        if (sInstance == null) {
            synchronized (ServiceManager23.class) {
                if (sInstance == null) {
                    sInstance = new ServiceManager23();
                }
            }
        }
        return sInstance;
    ...
    private void proxyCreateService(ServiceInfo serviceInfo) throws Throwable {
        ...
        //TODO:插件APK的路径
        String path = MApplication.getInstance().getFileStreamPath("servicePlugin-debug.apk").getPath();
