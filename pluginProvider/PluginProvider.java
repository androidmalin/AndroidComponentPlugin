...
public class PluginProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        ...
        String insertUserSql1 = "insert into " + USER_TABLE + " values(1,'jake1');";
        String insertUserSql2 = "insert into " + USER_TABLE + " values(2,'jake2');";

        String deleteJobSql = "delete from " + JOB_TABLE;
        String insertJobSql1 = "insert into " + JOB_TABLE + " values(1,'job1');";
        String insertJobSql2 = "insert into " + JOB_TABLE + " values(2,'job2');";
    ...
    private class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String createJobSql = "CREATE TABLE IF NOT EXISTS " + JOB_TABLE_NAME + "(_id INTEGER PRIMARY KEY AUTOINCREMENT," + " jobs TEXT)";
