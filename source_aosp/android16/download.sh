...
wget -c http://androidxref.com/4.1.2/raw/frameworks/base/services/java/com/android/server/am/ActivityManagerService.java
wget -c http://androidxref.com/4.1.2/raw/frameworks/base/core/java/android/content/pm/ApplicationInfo.java
wget -c http://androidxref.com/4.1.2/raw/frameworks/base/core/java/android/app/ContextImpl.java
